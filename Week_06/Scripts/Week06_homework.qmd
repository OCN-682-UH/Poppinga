...
I wanted to try a density plot from ggplot to make the data visualization awesome. I'm still trying to understand this data in the right context, but it was good practice to struggle with the making of this plot. I will work on a plot that makes more sense in the future.
...
ChemData_clean<-ChemData %>% #Nyssa's groundwater data
  ...
  mutate(Season = factor(Season, levels = c("SPRING","FALL")),
         ...
         Season = recode(Season, "SPRING" = "Spring", "FALL" = "Fall"))
...
season_name<-list(c(SPRING = "Spring"), c(FALL = "Fall")) #get rid of all caps
...
ChemData_clean %>%
  drop_na() %>%
  pivot_longer(cols = c(pH, Salinity), #make data longer
               names_to = "Variable",
               values_to = "Value") %>%
...
@tbl-chemdata has information on the mean values for pH and salinity by different seasons.
