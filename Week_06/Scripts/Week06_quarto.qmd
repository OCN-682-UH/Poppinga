...
[Required Reading](https://quarto.org/docs/get-started/hello/rstudio.html)  
[Required Reading r4ds](https://r4ds.hadley.nz/quarto.html)  
[Lecture Slides](https://raw.githack.com/OCN-682-UH/Fall_2025/main/Week_06/11_qurato_intro.html#/title-slide)  
...
* Regarding code chunks in Quarto, which statement is correct? -> You can supply options inside the chunk header (after the pipe | and #) to control output behavior.  
* Which option is used to adjust how wide a figure appears relative to the page? -> out-width  
* Suppose you are writing a Quarto document in GitHub flavored markdown format (gfm). Which limitation was noted in the lecture? -> You cannot include HTML interactive tables directly; you might need webshot2 to convert them to screenshots.  
* In Quarto, what does the echo: false option inside a code chunk do? -> Hides the code but still shows its results  
...
[Lecture Slides](https://raw.githack.com/OCN-682-UH/Fall_2025/main/Week_06/12_quarto2.html#/title-slide)  
...
An extra plot that doesn't really make sense:  
```{r}
#| warning: false
#| out-width: "70%"
#| fig-align: "center"
