...
1.  Before class starts, navigate to "Fall-2025" in your projects (upper right-hand corner of RStudio) and **pull.**
...
```{r, eval=FALSE}
my_data <- read_csv("usr/nsilbiger/My Documents/ComputerModeling/Fall 2025/Lab 1/data/some_data.csv”)
...
- Copy the **"weightdata.csv"** file from the Fall-2025 repo into your own private repo.  Put it in the **data** folder within **Week_02**.  
