...
Quiz:  
In a shiny app, the server is where you create the appearance of your app. These functions essentially write html code.   --> True  

plotOutput("plot1") --> ui  
output$plot1<- R Code --> server  

What is wrong with my code?  
sliderInput(inputID = "num",  
label = "Choose a number",  
value = 25, min = 1, max = 100 )  
--> "ID" should be spelt "Id". 
