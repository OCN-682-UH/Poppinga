...
# Start your script or Quarto file

**Note**: You can use whatever you want to take notes in class, but your homeworks have to be turned in as a Quarto document from now on. 
...
I really like the *rnaturalearth* package for some more advanced plotting with the sf package.  Check it out [here](https://github.com/ropensci/rnaturalearth)
...
You cannot follow along in class without the google API key. It requires a credit card, but you need to make 40,000 maps before you get charged (i.e. unless you are a developer you will never get charged). After 40,000 maps per month is is $0.005 per map. Follow the directions starting at ["Enable Google static map service for ggmap"](https://www.littlemissdata.com/blog/maps). If you don't feel comfortable doing this then you can just follow along in class online. Also, important, you **need to use a gmail account to set up your google API.**  I also added step-by-step instructions to Lamaku.
