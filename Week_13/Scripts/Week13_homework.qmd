...
tp_data
# write_csv(tp_data, here("Week_13","Output","tp_maploop_homework.csv")) # export csv file
```
...
tpfiles<-dir(path = week13path, pattern = ".csv", full.names = TRUE) # save the entire file path name from computer using full.names = TRUE
tpfiles
