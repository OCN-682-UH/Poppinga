...
# Pivot Longer
  pivot_longer(cols = c(pH, Salinity, NN, Silicate, Phosphate, TA, percent_sgd), # parameters
...
# register_google(key = "") # use your own API in between the "" in R console after running libraries
...
# All the body of what we want the function to do 
